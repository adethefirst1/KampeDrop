...
function useStackProgress(sectionRef: RefObject<HTMLElement | null>) {
            ...
            {CATEGORIES.map((cat) => (
              <li key={cat.id}>
                ...
                >
                  ...
                  <p className="mt-2 text-sm" style={{ color: cat.muted }}>
                    {cat.description}
                  </p>
                </Link>
              </li>
  ...
  return (
    ...
    >
      <div className="sticky top-0 h-svh overflow-hidden">
        ...
        <div className="absolute inset-0 z-10 px-2 pb-[max(2.75rem,env(safe-area-inset-bottom))] pt-[max(0.5rem,env(safe-area-inset-top))] sm:px-3 md:px-4">
        ...
        <div className="pointer-events-none absolute inset-x-0 top-0 z-20 px-4 pt-[max(0.75rem,env(safe-area-inset-top))] sm:px-6">
